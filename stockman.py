...
mycon=sql.connect(host="localhost",user="root",password="lucky@1234",database="google")
mycur=mycon.cursor()
win=Tk()
pid=StringVar()
pn=StringVar()
...
image=PhotoImage(file="c:\\users\\user\\Onedrive\\desktop\\hubnet.png")
win.iconphoto(False,image)
l1=Label(win,text="Hubnet Stock Management System",bg="black",fg="white",font=("monotype corsiva",20,"bold"),bd=5)
l1.pack(padx=0,pady=5)
cl=Label(win,text="select productid",bg="lightgreen",font=("algerian",12,"bold"))
cl.place(x=20,y=80)
cbb=StringVar()
...
l2=Label(win,text="Product ID   : ",bg="lightgreen",font=("algerian",12,"bold"))
l2.place(x=20,y=130)
l3=Label(win,text="Product Name : ",bg="lightgreen",font=("algerian",12,"bold"))
l3.place(x=20,y=180)
l4=Label(win,text="Product Qnt  : ",bg="lightgreen",font=("algerian",12,"bold"))
l4.place(x=20,y=230)
l5=Label(win,text="Product Rate : ",bg="lightgreen",font=("algerian",12,"bold"))
l5.place(x=20,y=280)
...
e5.place(x=80,y=380)
l6=Label(win,text="Email : https://www.hubnettech.net",font=("algerian",16,"bold"),bg="white",fg="black")
l6.place(x=30,y=450)
win.mainloop()
